...
# ── 场景编排 ───────────────────────────────────────────────
SCENARIOS = [
    {"id":"itinerary","emoji":"🗓","title":"周末一日游编排","color_cls":"s0",
     "query":"「周六带女朋友去青岛玩一天，预算500，帮我排好行程」",
     "steps":[{"emoji":"📅","label":"日历管理","action":"查周六空闲时段"},
              {"emoji":"🧭","label":"位置切换","action":"默认济南→青岛"},
              {"emoji":"🎭","label":"娱乐活动","action":"搜青岛景点候选"},
              {"emoji":"🍣","label":"美食推荐","action":"选午/晚餐厅"},
              {"emoji":"📋","label":"智能编排","action":"排最优时间线+预算"},
              {"emoji":"📝","label":"预订","action":"一键订餐位"}]},
    {"id":"dineloop","emoji":"🍜","title":"今晚吃什么 → 订 → 评","color_cls":"s1",
     "query":"「想吃日料，不要太贵，安静点，帮我订好位」",
     "steps":[{"emoji":"🍣","label":"美食推荐","action":"过滤日料+安静+预算"},
              {"emoji":"📝","label":"预订","action":"选定后订位"},
              {"emoji":"🧠","label":"记忆系统","action":"记录本次偏好"},
              {"emoji":"💬","label":"评价","action":"到店后邀请评价"}]},
    {"id":"proactive","emoji":"☀️","title":"全天候主动播报","color_cls":"s2",
     "query":"「每天早晚自动推送，天气和日程冲突主动提醒」",
     "steps":[{"emoji":"🌤","label":"天气服务","action":"获取今/明天气"},
              {"emoji":"📅","label":"日历管理","action":"读取当日日程"},
              {"emoji":"⏰","label":"Cron调度","action":"定时主动触发"},
              {"emoji":"📢","label":"早晚安播报","action":"生成并推送"},
              {"emoji":"⚠️","label":"天气-日程冲突","action":"恶劣天气+户外日程预警"}]},
    {"id":"event","emoji":"🎟","title":"找个活动去","color_cls":"s3",
     "query":"「周末有什么好玩的，天气好就户外，天气差就室内」",
     "steps":[{"emoji":"🌤","label":"天气服务","action":"预判周末天气"},
              {"emoji":"🎭","label":"娱乐活动","action":"天气联动筛选"},
              {"emoji":"📡","label":"高德地图","action":"获取活动POI"},
              {"emoji":"🗺️","label":"出行规划","action":"规划前往路线"},
              {"emoji":"📖","label":"Wikipedia","action":"附地点实景图"}]},
]
